                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Banners->file_en!="")
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-4 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ nhaude_asset('uploads/banners/'.$Banners->file_en) }}"><img
                                                                    src="{{ nhaude_asset('uploads/banners/'.$Banners->file_en) }}"
                                        ...
                                        @else
                                            <a target="_blank"
                                               href="{{ nhaude_asset('uploads/banners/'.$Banners->file_en) }}">{!!  $Banners->file_en !!}</a>
                                        @endif
                                    @endif
                                    {!! Form::file($file1, array('class' => 'form-control','id'=>'file_en','accept'=>$file_allow)) !!}
                                </div>
                            </div>
                        @endif */?>
                        @if(Helper::GeneralWebmasterSettings("en_box_status"))
