...
@section('headerInclude')
    <link href="{{ nhaude_asset("backEnd/libs/jquery/bootstrap-daterangepicker/daterangepicker-bs3.css") }}" rel="stylesheet"
          type="text/css"/>
@endsection
@section('content')
    <div class="padding">
...
@section('footerInclude')
    <script src="{{ nhaude_asset("backEnd/libs/jquery/bootstrap-daterangepicker/moment.min.js") }}"
            type="text/javascript"></script>
    <script src="{{ nhaude_asset("backEnd/libs/jquery/bootstrap-daterangepicker/daterangepicker.js") }}"
            type="text/javascript"></script>
