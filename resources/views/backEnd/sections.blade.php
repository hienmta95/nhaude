                                ...
                                <td>
                                    @if($Section->photo !="")
                                        <div class="pull-right">
                                            <img src="{{ nhaude_asset('uploads/sections/'.$Section->photo) }}"
                            ...
                            @foreach($Section->fatherSections as $subSection)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($subSection->photo !="")
                                            <div class="pull-right">
                                                <img src="{{ nhaude_asset('uploads/sections/'.$subSection->photo) }}"
                                                     style="height: 30px" alt="{{ $title }}">
                                            </div>
                                        @endif
                                        <img src="{{ nhaude_asset('backEnd/assets/images/treepart_'.trans('backLang.direction').'.png') }}"
                                             class="submenu_tree">
