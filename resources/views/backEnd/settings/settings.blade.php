...
@section('headerInclude')
    <link rel="stylesheet"
          href="{{ nhaude_asset('backEnd/libs/jquery/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}"
          type="text/css"/>
@endsection
@section('content')
    <div class="padding">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-12 box p-a-xs text-center">
                                                        <a target="_blank"
                                                           href="{{ nhaude_asset('uploads/settings/'.$Setting->style_logo_ar) }}"><img
                                                                    src="{{ nhaude_asset('uploads/settings/'.$Setting->style_logo_ar) }}"
                                        ...
                                        @else
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-12 box p-a-xs text-center">
                                                        <img
                                                                src="{{ nhaude_asset('uploads/settings/nologo.png') }}"
                                                                class="img-responsive" id="style_logo_ar_prv"
                                                                style="width: auto;max-width: 260px;max-height: 60px">
                                                        <br>
                                        ...
                                        @if($Setting->style_logo_en!="")
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-12 box p-a-xs text-center">
                                                        <a target="_blank"
                                                           href="{{ nhaude_asset('uploads/settings/'.$Setting->style_logo_en) }}"><img
                                                                    src="{{ nhaude_asset('uploads/settings/'.$Setting->style_logo_en) }}"
                                    ...
                                    @if($Setting->style_fav!="")
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="col-sm-12 box p-a-xs text-center">
                                                    <a target="_blank"
                                                       href="{{ nhaude_asset('uploads/settings/'.$Setting->style_fav) }}"><img
                                                                src="{{ nhaude_asset('uploads/settings/'.$Setting->style_fav) }}"
                                    ...
                                    @else
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="col-sm-12 box p-a-xs text-center">
                                                    <a target="_blank"
                                                       href="{{ nhaude_asset('uploads/settings/nofav.png') }}"><img
                                                                src="{{ nhaude_asset('uploads/settings/nofav.png') }}"
                                                                class="img-responsive" id="style_fav_prv"
                                                                style="max-width: 60px;height: 60px">
                                                        <br>
                                    ...
                                    @if($Setting->style_apple!="")
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="col-sm-12 box p-a-xs text-center">
                                                    <a target="_blank"
                                                       href="{{ nhaude_asset('uploads/settings/'.$Setting->style_apple) }}"><img
                                                                src="{{ nhaude_asset('uploads/settings/'.$Setting->style_apple) }}"
                                            ...
                                            @for($i=1;$i<=24;$i++)
                                                ...
                                                <div class="col-sm-3">
                                                    <label class="ui-check ui-check-md">
                                                        ...
                                                        <i class="dark-white"></i>
                                                        <img src="{{ nhaude_asset('uploads/pattern/'.$img_name) }}"
                                            ...
                                            @if($Setting->style_bg_image!="")
                                                <div>
                                                    <div>
                                                        <div class="col-sm-12 box p-a-xs text-center">
                                                            <a target="_blank"
                                                               href="{{ nhaude_asset('uploads/settings/'.$Setting->style_bg_image) }}"><img
                                                                        src="{{ nhaude_asset('uploads/settings/'.$Setting->style_bg_image) }}"
                                            ...
                                            <div>
                                                <div>
                                                    <div id="footer_bg" class="col-sm-8 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ nhaude_asset('uploads/settings/'.$Setting->style_footer_bg) }}"><img
                                                                    src="{{ nhaude_asset('uploads/settings/'.$Setting->style_footer_bg) }}"
                                                                    class="img-responsive">
...
@section('footerInclude')
    ...
    <script src="{{ nhaude_asset('backEnd/libs/jquery/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>
    <script>
        $(function () {
            $('#cp1').colorpicker({
                colorSelectors: {
