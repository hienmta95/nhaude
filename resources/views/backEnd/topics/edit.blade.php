...
@section('headerInclude')
    <link href="{{ nhaude_asset("backEnd/libs/js/iconpicker/fontawesome-iconpicker.min.css") }}" rel="stylesheet">
    <!--[if lt IE 9]>
                                        ...
                                        @if($Topics->video_type==0 && $Topics->video_file!="")
                                            <div class="box p-a-xs">
                                                ...
                                                <video width="380" height="230" controls>
                                                    <source src="{{ nhaude_asset('uploads/topics/'.$Topics->video_file) }}"
                                                            type="video/mp4">
                                                    Your browser does not support the video tag.
                                                </video>
                                                <br>
                                                <a target="_blank"
                                                   href="{{ nhaude_asset('uploads/topics/'.$Topics->video_file) }}">
                                                    {{ $Topics->video_file }} </a>
                                            </div>
                                        @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Topics->audio_file!="")
                                        <div class="box p-a-xs">
                                            <audio controls>
                                                <source src="{{ nhaude_asset('uploads/topics/'.$Topics->audio_file) }}"
                                                        type="audio/mpeg">
                                                Your browser does not support the audio element.
                                            </audio>
                                            <br>
                                            <a target="_blank"
                                               href="{{ nhaude_asset('uploads/topics/'.$Topics->audio_file) }}"> {{ $Topics->audio_file }} </a>
                                        </div>
                                    @endif
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div id="topic_photo" class="col-sm-4 box p-a-xs">
                                                <a target="_blank"
                                                   href="{{ nhaude_asset('uploads/topics/'.$Topics->photo_file) }}"><img
                                                            src="{{ nhaude_asset('uploads/topics/'.$Topics->photo_file) }}"
                                ...
                                <div class="col-sm-10">
                                    @if($Topics->attach_file!="")
                                        <div id="topic_attach" class="col-sm-4 box p-a-xs">
                                            <a target="_blank"
                                               href="{{ nhaude_asset('uploads/topics/'.$Topics->attach_file) }}"> {{ $Topics->attach_file }} </a>
                                            <br>
                                            ...
                                            <div class="col-sm-10">
                                                @if($cf_saved_val !="")
                                                    ...
                                                    <div id="{{$file_name_id}}" class="col-sm-4 box p-a-xs">
                                                        <video width="380" height="230" controls>
                                                            <source src="{{ nhaude_asset('uploads/topics/'.$cf_saved_val) }}"
                                                                    type="video/mp4">
                                                            Your browser does not support the video tag.
                                                        </video>
                                                        <a target="_blank"
                                                           href="{{ nhaude_asset('uploads/topics/'.$cf_saved_val) }}">
                                                            {{ $cf_saved_val }}
                                                        </a>
                                                        <br>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                @if($cf_saved_val !="")
                                                    ...
                                                    <div id="{{$file_name_id}}" class="col-sm-4 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ nhaude_asset('uploads/topics/'.$cf_saved_val) }}"><img
                                                                    src="{{ nhaude_asset('uploads/topics/'.$cf_saved_val) }}"
                                                                    class="img-responsive">
                                                            {{ $cf_saved_val }}
                                                        </a>
                                                        <br>
                  ...
                  <span class="fa fa-calendar"></span>
                                    ...
                                    @elseif($customField->type ==1)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::textarea('customField_'.$customField->id,$cf_saved_val, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control',$cf_required=>'', 'dir'=>$cf_land_dir,'rows'=>'5')) !!}
                                            </div>
                                        </div>
                                    @else
                                        {{--Text Box--}}
                        ...
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <div class="dz-message" ui-jp="dropzone"
                                     ui-options="{ url: '{{ nhaude_asset('backEnd/api/dropzone') }}' }">
                                    ...
                                    @foreach($Topics->photos as $photo)
                                        <div class="col-xs-6 col-sm-4 col-md-3">
                                            <div class="box p-a-xs">
                                                ...
                                                <img src="{{ nhaude_asset('uploads/topics/'.$photo->file) }}"
                                                ...
                                                <div class="p-a-sm">
                                                    <div class="text-ellipsis">
                                                        ...
                                                        <a style="display: block;overflow: hidden;"
                                                           href="{{ nhaude_asset('uploads/topics/'.$photo->file) }}"
                                                           target="_blank">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="col-sm-4 box p-a-xs">
                                                    <a target="_blank"
                                                       href="{{ nhaude_asset('uploads/topics/'.Session::get('AttachFile')->file) }}"> {!! Helper::GetIcon(nhaude_asset('uploads/topics/'),Session::get('AttachFile')->file) !!} {{ Session::get('AttachFile')->file }} </a>
                                                </div>
                                            ...
                                            @foreach($Topics->attachFiles as $file)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ nhaude_asset('uploads/topics/'.$file->file) }}"
                                                           target="_blank">
                                                            {!! Helper::GetIcon(nhaude_asset('uploads/topics/'),$file->file) !!}
                                                            {{$file->file}}</a>
                                                    </td>
                                                    <td>
                                                        <small>
                                                        ...
                                                        <div>
                                                            ...
                                                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::textarea('details_en','', array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control','id'=>'details_en','rows'=>'3', 'dir'=>trans('backLang.ltr'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                        ...
                                                        @foreach($Topics->maps as $map)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <img src="{{ nhaude_asset('backEnd/assets/images/marker_').$map->icon.".png" }}"
                                                                         style="width: 20px;">
                                                                    @if($title !="")
                                                                        <small>{!! $title !!}</small>
                                                                    @else
...
@section('footerInclude')
    ...
    @if($WebmasterSection->maps_status)
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var iconURLPrefix = "{{ nhaude_asset('backEnd/assets/images/')."/" }}";
                var icons = [
    ...
    @endif
    <script src="{{ nhaude_asset("backEnd/libs/js/iconpicker/fontawesome-iconpicker.js") }}"></script>
    <script>
        $(function () {
