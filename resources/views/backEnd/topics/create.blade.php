                  ...
                  <span class="fa fa-calendar"></span>
                            ...
                            @elseif($customField->type ==1)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::textarea('customField_'.$customField->id,$customField->default_value, array('ui-jp'=>'summernote', 'placeholder' => '','class' => 'form-control summernote',$cf_required=>'', 'dir'=>$cf_land_dir,'rows'=>'5')) !!}
                                    </div>
                                </div>
                            @else
                                {{--Text Box--}}
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::text('customField_'.$customField->id,$customField->default_value, array('ui-jp'=>'summernote', 'placeholder' => '','class' => 'form-control summernote','id'=>'customField_'.$customField->id,$cf_required=>'', 'dir'=>$cf_land_dir)) !!}
                                    </div>
                                </div>
                            @endif
                        @endif
