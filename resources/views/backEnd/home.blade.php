...
@section('headerInclude')
    <link rel="stylesheet" type="text/css" href="{{ nhaude_asset("backEnd/assets/styles/flags.css") }}"/>
@endsection
@section('content')
                ...
                @if(@Auth::user()->permissionsGroup->newsletter_status)
                    <div class="col-md-12 col-xl-{{$col_width}}">
	                	...
	                	<span class="w-40 avatar">
                            @if($Contact->photo!="")
                                <img src="{{ nhaude_asset('uploads/contacts/'.$Contact->photo) }}"
                                     alt="{{ $Contact->first_name }} {{ $Contact->last_name }}">
                            @else
                                <img src="{{ nhaude_asset('uploads/contacts/profile.jpg') }}"
