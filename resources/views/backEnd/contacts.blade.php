                ...
                <div class="col-sm-4 col-md-3 bg b-r">
                    ...
                    <span class="w-40 avatar">
                        <a href="{{ route("contactsEdit",["id"=>$Contact->id]) }}">
                            @if($Contact->photo!="")
                                <img src="{{ nhaude_asset('uploads/contacts/'.$Contact->photo) }}" class="img-circle">
                            @else
                                <img src="{{ nhaude_asset('uploads/contacts/profile.jpg') }}" class="img-circle"
                                     style="opacity: 0.5">
                            @endif
                        </a>
                    </span>
                        ...
                        @if($Contacts->total() > env('BACKEND_PAGINATION', 30))
                                                ...
                                                <div class="avatar w-64 inline">
                                                    @if(Session::get('ContactToEdit')->photo !="")
                                                        <img id="photo_preview"
                                                             src="{{ nhaude_asset('uploads/contacts/'.Session::get('ContactToEdit')->photo) }}">
                                                    @else
                                                        <img id="photo_preview"
                                                             src="{{ nhaude_asset('uploads/contacts/profile.jpg') }}"
                                                             style="opacity: 0.2">
                                                    @endif
                                                </div>
                                                <div class="form-file">
