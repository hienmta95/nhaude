<header>
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route("Home") }}">
                    @if(Helper::GeneralSiteSettings("style_logo_" . trans('backLang.boxCode')) !="")
                        <img alt=""
                             src="{{ nhaude_asset('uploads/settings/'.Helper::GeneralSiteSettings("style_logo_" . trans('backLang.boxCode'))) }}">
    ...
    <!-- Pixel Code for https://tuongtac.net/ -->
<script async src="https://tuongtac.net/pixel/c15aaec069fc8c01bdc02e54bce7371b"></script>
<!-- END Pixel Code -->
