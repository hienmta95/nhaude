...
@section('content')
    ...
    <section id="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-{{(count($Categories)>0)? "8":"10 col-md-offset-1"}}">
                    ...
                    <article>
                                ...
                                <div class="video-container">
                                    ...
                                    @else
                                        <video width="100%" height="450" controls autoplay>
                                            <source src="{{ nhaude_asset('uploads/topics/'.$Topic->video_file) }}"
                                                    type="video/mp4">
                        ...
                        @elseif($WebmasterSection->type==3 && $Topic->audio_file!="")
                            ...
                            <div class="post-video">
                                ...
                                @if($Topic->photo_file !="")
                                    <img src="{{ nhaude_asset('uploads/topics/'.$Topic->photo_file) }}"
                                         alt="{{ $title }}"/>
                                @endif
                                <div>
                                    <audio controls autoplay>
                                        <source src="{{ nhaude_asset('uploads/topics/'.$Topic->audio_file) }}"
                                                type="audio/mpeg">
                                            ...
                                            @if(($cf_saved_val!="" || count($cf_saved_val_array) > 0) && ($customField->lang_code == "all" || $customField->lang_code == trans('backLang.boxCode')))
                                                ...
                                                @elseif($customField->type ==9)
                                                    ...
                                                    <div class="row field-row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <a href="{{ nhaude_asset('uploads/topics/'.$cf_saved_val) }}"
                                                               target="_blank">
                                                                <span class="badge">
                                                                    {!! Helper::GetIcon(nhaude_asset('uploads/topics/'),$cf_saved_val) !!}
                                                                    {!! $cf_saved_val !!}</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                @elseif($customField->type ==8)
                                                    ...
                                                    <div class="row field-row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <img src="{{ nhaude_asset('uploads/topics/'.$cf_saved_val) }}"
                                                                 alt="{{ $cf_title }} - {{ $title }}"
                            ...
                            <div class="bottom-article">
                                @if($file_ext ==".jpg"|| $file_ext ==".jpeg"|| $file_ext ==".png"|| $file_ext ==".gif")
                                    <div class="text-center">
                                        <img src="{{ nhaude_asset('uploads/topics/'.$Topic->attach_file) }}"
                                             alt="{{ $title }}"/>
                                    </div>
                                @else
                                    <a href="{{ nhaude_asset('uploads/topics/'.$Topic->attach_file) }}">
                                        <strong>
                                            {!! Helper::GetIcon(nhaude_asset('uploads/topics/'),$Topic->attach_file) !!}
                            ...
                            <div style="padding: 10px;border: 1px dashed #ccc;margin-bottom: 10px;">
                                @foreach($Topic->attachFiles as $attachFile)
                                    ...
                                    <div style="margin-bottom: 5px;">
                                        <a href="{{ nhaude_asset('uploads/topics/'.$attachFile->file) }}" target="_blank">
                                            <strong>
                                                {!! Helper::GetIcon(nhaude_asset('uploads/topics/'),$attachFile->file) !!}
                                                &nbsp;{{ $file_title }}</strong>
                                        </a>
                                    </div>
                                @endforeach
                            ...
                            <div id="comments">
                                @if(count($Topic->approvedComments)>0)
                                    ...
                                    @foreach($Topic->approvedComments as $comment)
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <img src="{{ nhaude_asset('uploads/contacts/profile.jpg') }}" class="profile"
                                                     alt="{{$comment->name}}">
