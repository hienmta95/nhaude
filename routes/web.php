...
Route::redirect('http://www.refber.vn/noi-dung/refber-chung-toi-la-ai-328', 'https://refber.vn/gioi-thieu', 301);
...
Route::Group(['prefix' => backendPath()], function () {
...
Route::get('/khoa-hoc/{id}/{slug?}',[
    'uses' => 'FrontendHomeController@getServicePage',
    'as' => 'service.detail'
]);
...
Route::get('http://www.refber.vn/noi-dung/refber-chung-toi-la-ai-328', function () {
    return Redirect::to('https://refber.vn/gioi-thieu');
});
